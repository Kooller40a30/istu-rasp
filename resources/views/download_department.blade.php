...
@section('content')
    <div class="container w-50">
        <form id="formFileDepartment" method="POST" action="{{ url('/download_departments') }}" enctype="multipart/form-data">
            @csrf
            <div class="d-grid gap-1 w-25 p-3 position-absolute top-50 start-50 translate-middle">
                <label class="mb-lg-3 text-center fs-3 fw-bold" for="ExcelFile">Загрузите кафедры</label>
                @if($errors->any())
            ...
            $(document).ready(function () {
                ...
                $('#formFileDepartment').ajaxForm({
                    ...
                    complete: function (xhr) {
                        ...
                        mess.html('<div class = "alert alert-success">Кафедры загружены</div>');

...
@section('title')
    Загрузка факультетов/институтов
@endsection

@section('content')
    <div class="container w-50">
        <form id="formFileFaculty" method="POST" action="{{ url('/download_faculties') }}" enctype="multipart/form-data">
            @csrf
            <div class="d-grid gap-1 w-25 p-3 position-absolute top-50 start-50 translate-middle">
                <label class="mb-lg-3 text-center fs-3 fw-bold" for="ExcelFile">Загрузите институты/факультеты</label>
                @if($errors->any())
            ...
            $(document).ready(function () {
                ...
                $('#formFileFaculty').ajaxForm({
                    ...
                    success: function (xhr) {
                        ...
                        mess.html('<div class = "alert alert-success">Институты/факультеты загружены</div>');

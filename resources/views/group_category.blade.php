    ...
    <div class="card-body">
        <form method="get" action="{{route('groups_schedule')}}">
            ...
            <div class="row">
                ...
                <select class="selectize-js mb-3" name="faculty" id="group_faculty">
            ...
            <div class="row">
                ...
                <select class="selectize-js mb-3" name="course" id="course-dropdown">
            ...
            <div class="row">
                ...
                <select class="selectize-js mb-3" name="group" id="group-dropdown">

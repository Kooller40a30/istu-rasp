    ...
    <div class="card-body">
        <form method="post" action="http://istu-rasp/classrooms_faculty">
            ...
            <div class="row">
                ...
                <select class="form-select mb-3 selectize-js" name="faculty" id="room_faculty">
            ...
            <div class="row">
                ...
                <select class="form-select mb-3 selectize-js" name="department" id="room_department">
            ...
            <div class="row">
                ...
                <select class="form-select mb-3 selectize-js" name="classroom" id="classroom">
